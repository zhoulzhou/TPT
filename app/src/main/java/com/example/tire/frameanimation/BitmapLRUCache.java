...
//    private LinkedHashMap mSoftBitmapCache;//软引用缓存,已清理的数据可能会再次使用
    ...
    public static BitmapLRUCache getInstance(int maxHardSize) {
        if (mInstance == null) {
            LogUtils.d("BitmapLRUCache getInstance maxHardSize= " + maxHardSize);
...
//                LogUtils.d("BitmapLRUCache SoftCacheSize= " + size());
...
//                            LogUtils.d("BitmapLRUCache SoftCacheRemoveEldestEntry oldValue= " + oldValue);
...
//        };
    ...
    public Drawable getBitmap(int url) {
        ...
        if (mCurBitmap != null) {
            LogUtils.d("BitmapLRUCache getBitmapFromHardCache bitmap= " + mCurBitmap);
            return mCurBitmap;
        }
...
//                    LogUtils.d("BitmapLRUCache getBitmapFromSoftCache bitmap= " + mCurBitmap);
//                    return mCurBitmap;
//                } else {
//                    LogUtils.d("BitmapLRUCache getBitmap mCurBitmap is null");
//                    mSoftBitmapCache.remove(url);
//                }
//            }
//        }
    ...
    protected void entryRemoved(boolean evicted, Object key, Object oldValue, Object newValue) {
        ...
        LogUtils.d("BitmapLRUCache entryRemoved oldValue= " + oldValue + "  evicted= " + evicted);
//        if (evicted) {
//            if (oldValue != null) {
//                //当硬缓存满了,根据LRU规则移入软缓存
//                synchronized (mSoftBitmapCache) {
